...
function App() {
  ...
  return (
    <>
      <div className='start-container' style={{ height: '100lvh', top: pressed ? '-100%' : 0, position: 'absolute', transition: 'top 0.3s ease-in-out' }} onClick={() => setPressed(true)}>
        <div className='start'>{currentPage === 0 ? `Start reading` : `Continue Reading`}</div>
      </div>
      <div style={{ height: '100lvh', top: pressed ? 0 : '100%', position: 'absolute', transition: 'top 0.3s ease-in-out' }}>
